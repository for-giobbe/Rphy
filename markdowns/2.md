# Inferring Distance-Based and Charachter-based Phylogenies
...
* Inferred some trees and understood how different approcahes yeld different trees (e.g., rooted versus unrooted, single vs multiple trees).
