...
- Take the current best tree and perform tree rearrangements on the bootstrapped dataset and save bootstrapped tree
- Use the bootstrapped tree and perform tree rearrangements on the original data set. If this tree has a lower parsimony score than the currently best tree, replace it.
