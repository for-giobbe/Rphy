...
trait_cols <- setNames(c(levels(data)[1],
                 levels(data)[1],
                 levels(data)[1],
                 levels(data)[1],
                 levels(data)[1]),
...
nodelabels(node=1:tree$Nnode+Ntip(tree),pie=fitARD$lik.anc,cex=0.42)
tiplabels(pie=to.matrix(data[tree$tip.label],levels(data)),cex=0.42)
...
Residuals:
     Min       1Q   Median       3Q      Max 
-165.106  -13.551    1.362   12.488  169.483 

Coefficients:
                 Estimate Std. Error t value Pr(>|t|)  
(Intercept)     -2.530466   2.288679  -1.106   0.2702  
mean_CDS_ln_PIC  0.015006   0.006201   2.420   0.0164 *
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 33.05 on 207 degrees of freedom
Multiple R-squared:  0.02751,	Adjusted R-squared:  0.02281 
F-statistic: 5.856 on 1 and 207 DF,  p-value: 0.01639
```
